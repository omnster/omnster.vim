...
hi Normal               ctermfg=7               ctermbg=232             guibg=#000000   guifg=#A0A0A0
"hi Cursor
hi CursorLine           cterm=none              ctermbg=234             guibg=#262626
hi CursorLineNr         cterm=none
"hi CursorIM
"hi Directory
hi DiffAdd              ctermbg=17              guifg=#00005f 
hi DiffChange           ctermbg=52              guibg=#5f0000
...
hi Comment              ctermfg=6       guifg=#00a7af
hi Constant             ctermfg=13      guifg=#875faf
hi Identifier           ctermfg=6                     guifg=#00d7af
hi Statement            ctermfg=11                    guifg=#ffff00
hi PreProc              ctermfg=12      guifg=#0000ff
hi Type                 ctermfg=2       guifg=#00cf00
hi Special              ctermfg=9       guifg=#cf1f1f
hi Underlined           ctermfg=12              cterm=underline
hi Ignore               ctermfg=0
hi Error                ctermfg=15              ctermbg=9 guibg=#ffffff guifg=#af0000
hi Todo                 ctermfg=8               ctermbg=6 guibg=#474747 guifg=#00d7af

" Popup menu

hi Pmenu                ctermfg=239             ctermbg=233     guifg=#4e4e4e guibg=#121212
hi PmenuSel             ctermfg=235             ctermbg=247     guifg=#262626 guibg=#9e9e9e
hi PmenuSbar            ctermfg=232             ctermbg=232     guifg=#080808 guibg=#080808
hi PmenuThumb           ctermfg=240             ctermbg=240     guifg=#585858 guibg=#585858

" StatusLine

 hi StatusLineNC               ctermfg=229             ctermbg=3 guifg=#ffffaf guibg=#dfdf00 
